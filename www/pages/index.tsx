...
const Index = () => {
  ...
  return (
    <div className="flex flex-col bg-black text-white items-center w-screen h-screen">
      <div className="w-full max-w-[800px] px-4">
        <Header />
        <p className="mb-4 text-sm">
          Welcome to mockbin2 (the revival). This is an open-source and
          fully-free tool that allows you to quickly mock an API endpoint,
